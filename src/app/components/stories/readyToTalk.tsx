  ...
  return (
    <section className="bg-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[50px] md:text-[83px] font-[600] text-[#3E3E3E] mb-2 font-sans">
          Ready to talk?
        </h2>
        <p className="text-[30px] md:text-[40px] text-[#3E3E3E] font-[500] mb-4 md:mb-2 font-sans leading-normal">
