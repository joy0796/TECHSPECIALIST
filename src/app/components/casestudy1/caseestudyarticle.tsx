    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-16 py-10 flex flex-col lg:flex-row gap-10 text-black">
      ...
      Digital transformation is not just about adopting tools. It is about rethinking processes, people, and platforms to unlock efficiency, resilience, and growth.</p>
        ...
        <div className="w-full md:w-1/2 h-64 md:mx-auto relative rounded-lg overflow-hidden shadow-md my-6">
                ...
                <p className="leading-loose mb-2 text-justify text-xs text-[#3E3E3E]">Thankfully, the narrative is not all gloomy. There are pockets of success stories of SMEs that embraced tech and thrived.</p>
                ...
                <p className="leading-loose mb-2 text-justify text-xs text-[#3E3E3E]">Instagram and TikTok are not just for dance videos many Nigerian fashion, beauty, and food brands have scaled nationally through social media marketing and influencer partnerships.</p>
                ...
                <ol>
                  ...
                  <p className="leading-loose mb-2 text-justify text-xs text-[#3E3E3E]">Collaborating with firms like Techspecialist Consulting ensures SMEs do not waste resources on the wrong tools or make costly tech mistakes.</p>
...
Whether you're a one-person bakery or a growing logistics startup, Techspecialist offers tools, support, and strategy to help your business compete in the digital age.
            ...
            <p className="leading-loose mb-2 text-justify text-xs text-[#3E3E3E]">The digital economy does not belong to multinationals alone. In fact, Nigerias biggest opportunity lies in digitally transforming its SMEs making them faster, safer, smarter, and more customer-focused.
