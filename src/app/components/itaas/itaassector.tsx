...
const sectors: Sector[] = [
  ...
  },
  {
    ...
    description:
      "Our experienced support teams provide round-the-clock IT assistance through 24/7 monitoring, proactive maintenance, and fast-response issue resolution. Whether you're facing unexpected technical disruptions or planning a system upgrade, we’re there every step of the way.",
    image: "/sector2.png", 
    imageLeft: true,
  },
  {
