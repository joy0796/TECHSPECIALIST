      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold text-[#3E3E3E]">
                {featuredPost.title}
              </h3>
          ...
          <div className="border-t border-gray-700 pt-4 lg:pt-0 lg:border-t-0 lg:border-l lg:pl-6 ">
            ...
            <ul className="space-y-4">
              {recommendedPosts.map((post, index) => (
                <li key={index} className="border-b border-black pb-2">
                  ...
                  <span className="text-xs text-gray-800">{post.category}</span>
                </li>
              ))}
            </ul>
          </div>
