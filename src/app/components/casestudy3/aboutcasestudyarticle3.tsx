    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-16 py-10 flex flex-col lg:flex-row gap-10 text-black">
      ...
      <article className="lg:w-3/4 w-full">
        <p className="text-sm font-bold mb-2 text-[#3E3E3E]">
          ...
          <p className="text-xs font-bold mb-2 text-[#3E3E3E]">•	Economic impact: <span className='font-normal'>The ICT sector contributed roughly 20% of GDP growth in Q2 2024, even as oil prices fluctuated. Nigeria is Africas largest mobile market, with about 163 million internet users (43.5% broadband penetration). Telecommunication alone was the third-largest GDP contributor in mid-2024.</span></p>
          ...
          <p className="leading-loose mb-2 text-justify text-xs text-[#3E3E3E]">In short, Nigerias future prosperity is tied to digital progress. This makes smart IT management not just a technical concern, but a national priority.
</p>
