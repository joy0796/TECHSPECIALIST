...
export default function JoinUsSection() {
  return (
    <section className="bg-white text-black pt-2 px-4 pb-6">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold mb-2 text-[#3E3E3E]">
        ...
        <button className="bg-[#ED5D25] text-white font-sm px-8 py-3 rounded] transition text-sm">
          JOIN US
        </button>
      </div>
    </section>
