...
export default function DigitalFindingSection() {
  ...
  return (
    <section className="w-full bg-white pl-4 md:pl-8 py-0 md:py-0 border-b border-red-400 h-[95vh]">
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-6 items-center pt-28 md:pt-14">
     ...
     data-aos-duration="2000">
          ...
          <h1 className="text-[30px] md:text-[50px] font-[600] font-custom text-[#3E3E3E] leading-[100%] mb-4">
        ...
        <div className="w-full h-[86vh] relative overflow-hidden shadow-md" data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000">
          <Image
