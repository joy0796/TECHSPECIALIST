      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-8">
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-between">
          <div className="text-gray-800 space-y-6 leading-relaxed text-justify">
            <p className='text-[19px] font-[400]'>
          ...
          <div className="mt-4 flex justify-between">
            <p>
              <strong className="text-[#3E3E3E] text-[23px] font-[600]">Kadir Salami</strong>{' '}
              <span className="text-gray-800 text-[19px] font-[400]">Chairman</span>
            </p>
        ...
        <div className='mt-auto whitespace-nowrap'>
            <Link href="/team">
            <button className="bg-[#F05A28] text-white font-[500] px-4 py-2 rounded hover:bg-orange-600 transition text-[19px]">
              Meet the team
            </button>
            </Link>
            </div>
