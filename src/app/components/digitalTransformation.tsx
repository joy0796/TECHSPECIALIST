...
export default function DigitalTransformationSection() {
  ...
  return (
    <section className="flex flex-col items-center justify-between px-6 pt-12 pb-24 gap-6">
      {step === 1 && (
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full">
          ...
          >
            <h1 className="text-4xl sm:text-[57px] font-semibold leading-tight text-gray-900 mt-16">
              Begin your <span className="text-orange-500">digital transformation</span> journey here
            </h1>
            <p className="mt-6 text-gray-600 text-[19px]">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-start gap-10 md:gap-24">
              {sectors.map((sector) => (
                <button
                  ...
                  className="px-8 py-3 border-2 border-gray-300 rounded-xl text-gray-800 font-medium hover:bg-orange-600 transition whitespace-nowrap font-medium"
                >
                  {sector}
                </button>
              ))}
