...
export default function HousingFeature() {
  ...
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      ...
      {/* Content Box */}
      <div className="absolute top-10 left-5 sm:left-10 bg-gradient-to-r from-black/60 via-black/70 to-transparent text-white max-w-3xl p-6 md:mt-14  shadow-lg border-l-4 border-[#F06322] mt-16 " data-aos="fade-up"
