...
export default function Mandate() {
  ...
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      ...
      {/* Content Box */}
      <div className="absolute top-10 left-5 sm:left-10 bg-gradient-to-r from-black/60 via-black/70 to-transparent text-white max-w-2xl px-4 py-6 md:mt-28 shadow-lg border-l-8 border-[#F06322] backdrop-blur-lg" data-aos="fade-up"
