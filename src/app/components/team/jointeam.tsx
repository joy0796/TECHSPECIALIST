  ...
  return (
    <section className="bg-[#3B7EEE] text-white px-4 md:px-14 py-20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[50px] md:text-[83px] font-[600] font-sans leading-tight mb-4">
          Join us & be a part of the future
        </h2>
        <p className="text-[20px] md:text-[23px] font-[500] font-sans leading-relaxed mb-10 max-w-3xl">
        ...
        <Link href="/careers" className="inline-block bg-[#ED5D25] hover:bg-orange-700 text-white font-[600] px-8 py-4 rounded transition duration-300 text-[20px] font-[sans]">
