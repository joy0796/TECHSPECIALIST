    ...
    <section className="relative w-full text-white overflow-hidden min-h-[80vh] md:min-h-[90vh]">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="bg-black/50 text-white rounded-t-2xl shadow-lg px-8 py-8 flex flex-col md:flex-row gap-4 md:gap-8 justify-between items-center w-full font-[500] whitespace-nowrap font-Roboto">
