...
export default function Section2() {
  ...
  return (
    <section className="w-full bg-white pI-4 md:pl-6 py-0 md:py-0 border-b border-red-400 h-[95vh]">
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-10 items-center pt-28 md:pt-16">
        {/* Left - Text and Icons */}
