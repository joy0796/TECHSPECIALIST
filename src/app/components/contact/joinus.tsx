...
export default function JoinUsSection() {
  return (
    <section className="bg-white text-black pt-2 px-4 md:px-14 mb-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-[40px] md:text-[83px] font-[600] mb-4 text-gray-800 font-custom leading-[100%]">
          Join us & be a part of the future
        </h2>
        <p className="text-gray-700 text-[23px] leading-[177%] mb-4 font-[500] font-custom">
        ...
        <button className="bg-[#ED5D25] text-white font-[600] px-10 py-4 rounded] transition text-[20px] font-custom">
          JOIN US
        </button>
      </div>
    </section>
