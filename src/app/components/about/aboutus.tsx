...
export default function Aboutus() {
  ...
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      ...
      {/* Content Box */}
      <div className="absolute blur-sm top-10 left-5 sm:left-10 bg-gradient-to-r from-black/80 via-black/60 to-transparent text-white max-w-4xl p-6 mt-14 rounded-md shadow-lg border-l-4 border-[#F06322]" data-aos="fade-up"
     data-aos-duration="1000">
        <p className="text-[57px] font-[600] uppercase text-[#FFFFFF] mb-2 mt-10 font-sans">About Us</p>
