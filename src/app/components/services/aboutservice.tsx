  ...
  return (
    <section className="relative w-full text-white overflow-hidden">
     ...
     data-aos-duration="1000">
        ...
        {/* <p>hello</p> */}
        <div className="hidden md:flex bg-black/50 text-white rounded-xl shadow-lg px-6 py-6 flex-col md:flex-row gap-8 justify-between items-center w-full font-[500] whitespace-nowrap font-Roboto  md:mt-14">
