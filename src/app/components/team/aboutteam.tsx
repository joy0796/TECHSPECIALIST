...
export default function Team() {
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      ...
      {/* Content Box */}
      <div className="absolute top-10 left-5 sm:left-10 bg-gradient-to-r from-black/40 via-black/70 to-transparent text-white max-w-4xl py-6 px-2 md:mt-14 rounded-md shadow-lg border-l-4 border-[#F06322]">
